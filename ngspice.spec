...
Source0  : https://downloads.sourceforge.net/project/ngspice/ng-spice-rework/39/ngspice-39.tar.gz
...
%prep
%setup -q -n ngspice-39
cd %{_builddir}/ngspice-39
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675881285
