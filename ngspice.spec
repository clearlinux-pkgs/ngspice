...
Source0  : https://sourceforge.net/projects/ngspice/files/ng-spice-rework/44/ngspice-44.tar.gz
...
%prep
%setup -q -n ngspice-44
cd %{_builddir}/ngspice-44
pushd ..
cp -a ngspice-44 buildavx2
popd
pushd ..
cp -a ngspice-44 buildavx512
popd
pushd ..
cp -a ngspice-44 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735574998
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libngspice.so.0.0.11
/V3/usr/lib64/ngspice/ivlng.so
/V4/usr/lib64/libngspice.so.0.0.11
/V4/usr/lib64/ngspice/ivlng.so
/VA/usr/lib64/libngspice.so.0.0.11
/VA/usr/lib64/ngspice/ivlng.so
/usr/lib64/libngspice.so.0
/usr/lib64/libngspice.so.0.0.11
