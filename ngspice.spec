...
Source0  : https://sourceforge.net/projects/ngspice/files/ng-spice-rework/43/ngspice-43.tar.gz
...
%prep
%setup -q -n ngspice-43
cd %{_builddir}/ngspice-43
pushd ..
cp -a ngspice-43 buildavx2
popd
pushd ..
cp -a ngspice-43 buildavx512
popd
pushd ..
cp -a ngspice-43 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721086023
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libngspice.so.0.0.10
/V4/usr/lib64/libngspice.so.0.0.10
/VA/usr/lib64/libngspice.so.0.0.10
/usr/lib64/libngspice.so.0
/usr/lib64/libngspice.so.0.0.10
